...
<form action="<?php echo U('Ad/edit_adwhere');?>" method="post" id="myform" enctype="multipart/form-data">
<table width="100%" class="table_form">
  <tbody>
  <tr>
    <th width="120">广告位名称</th>
    <td class="y-bg"><input type="text" class="input-text" name="title" id="title" size="30" value="<?php echo ($info["title"]); ?>" >&nbsp;&nbsp;&nbsp;&nbsp;<font color="gray">广告位名称</font></td>
  </tr>
</tbody></table>
</div>
<div class="bk15"></div>
