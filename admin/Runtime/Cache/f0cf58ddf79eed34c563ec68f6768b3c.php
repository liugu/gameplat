...
<table width="98%" border="0.2" class="table table-condensed table-striped">
  <tr>
    ...
    <td>来源:</td>
    <td>
    <input name="from" type="text" id="CopyFrom" value="0058游戏平台" size="14" maxlength="60">
    </td>
  </tr>
  <tr>
    ...
    <td>作者:</td>
    <td><input name="author" type="text" id="Author" value="0058小编" size="20" maxlength="200"></td>
  </tr>
  <tr>
    <td>所属栏目:</td>
