...
<form action="<?php echo U('Ad/add');?>" method="post" id="myform" enctype="multipart/form-data">
<table width="100%" class="table_form">
  <tbody>

  <tr>
    <th width="120">广告名称</th>
    <td class="y-bg"><input type="text" class="input-text" name="title" id="title" size="30" >&nbsp;&nbsp;&nbsp;&nbsp;<font color="gray">广告名称</font></td>
  </tr>
 <tr>
    <th width="120">广告类型</th>
    <td class="y-bg">
    <select id="type" name="type">
     <?php if(is_array($where_list)): $i = 0; $__LIST__ = $where_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;<font color="gray">广告类型</font></td>
   ...
   <tr>
    ...
    <td class="y-bg">
    <input name="status" value="0" type="radio" checked> 显示&nbsp;&nbsp;&nbsp;&nbsp;
	<input name="status" value="1" type="radio" > 不显示
  &nbsp;&nbsp;&nbsp;&nbsp;<font color="gray">是否显示</font></td>
  </tr>
   <tr>
    <th width="120">外链</th>
    <td class="y-bg"><input type="text" class="input-text" name="url" id="url" size="30" >&nbsp;&nbsp;&nbsp;&nbsp;<font color="gray">广告链接</font></td>
  </tr>
  <tr>
  <th width="120">图片</th>
...
&nbsp;&nbsp;&nbsp;&nbsp;<font color="gray"> </font></td>
    ...
    <th width="120">描述</th>
    <td class="y-bg"><textarea name="description" id="description" cols="50" rows="6"></textarea>
...
<td class="y-bg">
<input name="end_time" id="end_time" value="" size="20" class="date input-text" readonly="" type="text">&nbsp;<script type="text/javascript">
			Calendar.setup({
			weekNumbers: true,
		    inputField : "end_time",
		    trigger    : "end_time",
