...
<form name="myform" action="__URL__/adwhere_delete" method="post" >
...
<tbody>
<?php if(is_array($where_list)): $i = 0; $__LIST__ = $where_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
		...
		<td align="center">
			<a href="__URL__/edit_adwhere/id/<?php echo ($vo["id"]); ?>">修改</a> | <a href="__URL__/adwhere_delete/id/<?php echo ($vo["id"]); ?>">删除</a> 
		</td>
